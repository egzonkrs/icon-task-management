...
/// </summary>
public sealed class GetTicketByIdQueryHandler : IRequestHandler<GetTicketByIdQuery, Result<TicketDetailResponse>>
{
    ...
    public async Task<Result<TicketDetailResponse>> Handle(GetTicketByIdQuery request, CancellationToken cancellationToken)
    {
        ...
        return Result.Ok(TicketMapper.ToDetailResponse(ticket));
    }
}
