...
internal sealed class ChangeTicketStatusCommandHandlerBuilder
{
    ...
    public ChangeTicketStatusCommandHandlerBuilder WithAuthenticatedUser(string userId)
    {
        _userContextAccessorMock.Setup(x => x.UserId).Returns(userId);
        return this;
    }

    public ChangeTicketStatusCommandHandlerBuilder WithGetByIdReturnsNull()
    {
    ...
    public ChangeTicketStatusCommandHandlerBuilder WithGetByIdReturnsTicket(Ticket ticket)
    {
        _ticketRepositoryMock
            .Setup(x => x.GetByIdAsync(It.IsAny<Ulid>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(ticket);
    ...
    public ChangeTicketStatusCommandHandlerBuilder WithSaveChangesReturns(int result)
    {
        _unitOfWorkMock
    ...
    public ChangeTicketStatusCommandHandlerBuilder VerifyUpdateIsCalled(int timesCalled = 1)
    {
    ...
    public ChangeTicketStatusCommandHandlerBuilder VerifySaveChangesIsCalled(int timesCalled = 1)
    {
    ...
    public ChangeTicketStatusCommandHandlerBuilder VerifyGetByIdIsCalled(int timesCalled = 1)
    {
        _ticketRepositoryMock.Verify(
    ...
    public ChangeTicketStatusCommandHandlerBuilder VerifyUserIdIsCalled(int timesCalled = 1)
    {
    ...
    public ChangeTicketStatusCommandHandler Build()
    {
